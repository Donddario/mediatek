...
namespace MediaTekDocuments.Tests
{
    ...
    public class DvdTest
    {
        ...
        public void Dvd_Constructeur()
        {
            ...
            Assert.IsTrue(dvd.Duree > 0);

            // Vérifie que le réalisateur n'est pas une chaîne vide
            Assert.IsFalse(string.IsNullOrWhiteSpace(dvd.Realisateur));
        }
    }
}