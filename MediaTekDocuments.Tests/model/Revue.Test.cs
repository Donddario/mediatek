...
namespace MediaTekDocuments.Tests
{
    ...
    public class RevueTest
    {
        ...
        public void Revue_Constructeur()
        {
            ...
            // vérifie que la périodicité n'est pas vide
            Assert.IsFalse(string.IsNullOrWhiteSpace(revue.Periodicite));

            //vérifie que le délai de mise à dispo est strictement positif
            Assert.IsTrue(revue.DelaiMiseADispo > 0);
        }
    }
}