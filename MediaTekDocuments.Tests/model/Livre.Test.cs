...
namespace MediaTekDocuments.Tests
{
    ...
    public class LivreTest
    {
        ...
        public void Livre_Constructeur()
        {
            ...
            // Ajout : vérifie que l'ISBN n'est pas vide
            Assert.IsFalse(string.IsNullOrWhiteSpace(livre.Isbn));

            // Ajout : vérifie que l'auteur n'est pas null
            Assert.IsNotNull(livre.Auteur);
        }
    }
}