...
namespace MediaTekDocuments.Tests
{
    ...
    public class ExemplaireTest
    {
        ...
        public void Exemplaire_Constructeur()
        {
            ...
            // Ajout : vérifie que le numéro d'exemplaire est strictement positif
            Assert.IsTrue(exemplaire.Numero > 0);

            // Ajout : vérifie que la photo n'est pas null ou vide
            Assert.IsFalse(string.IsNullOrEmpty(exemplaire.Photo));
        }
    }
}